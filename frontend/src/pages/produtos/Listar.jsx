...
export default function Listar() {
  ...
  async function fetchProdutos() {
    const res = await axios.get("http://192.168.100.64:3000/api/produtos");
  ...
  async function adicionarAFila() {
    ...
    try {
      await axios.post("http://192.168.100.64:3000/api/bot/fila", {
  ...
  async function enviarSelecionados() {
    try {
      await axios.post("http://192.168.100.64:3000/api/bot/enviar", {
        produtos: selecionados,
  ...
  async function buscarProduto(e) {
    ...
    try {
      let p = await axios.get(`http://192.168.100.64:3000/api/produtos/${busca}`);
      setProdutos([p.data]);
    } catch {
      const res = await axios.get("http://192.168.100.64:3000/api/produtos");
  ...
  async function deletar(id) {
    ...
    await axios.delete(`http://192.168.100.64:3000/api/produtos/${id}`);
    fetchProdutos();
  }
  ...
  async function deletarSelecionados() {
    ...
    try {
      await axios.post("http://192.168.100.64:3000/api/produtos/delete-multiple", {
        ids: selecionados,
      });
