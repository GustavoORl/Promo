...
export default function Cadastrar() {
  ...
  try {
    ...
    // GERA O SLUG ANTES DE ENVIAR
    data.slug = form.title
      .toLowerCase()
      .trim()
      .replace(/\s+/g, "-")        // troca espaços por hífen
      .replace(/[^\w-]+/g, "");    // remove caracteres especiais

    await axios.post("https://promo-scda.onrender.com/api/produtos/", data);
  ...
  async function handleImportarShopee() {
    ...
    try {
      const res = await axios.get(`https://promo-scda.onrender.com/api/shopee/import?keyword=${keyword}&limit=${limit}`);
  ...
  async function handleUpdateShopee() {
    ...
    try {
      const res = await axios.get("https://promo-scda.onrender.com/api/shopee/update");
